...
function listNFTs() {
    for (let i = 0; i < NFT_num.length; i++) {
        ...
        console.log("Price: \t" + NFT_num[i]["Laptop Price"]);
...
mintNFT("Apple MacBook Air(M2)", 13.6, "Grey", "8GB", "256GB", "₹124900");
mintNFT("Asus Zenbook Pro Duo 14", 14.5, "Black", "32GB", "1TB", "₹92900");
mintNFT("Asus ROG Zephyrus G14", 14.5, "White", "8GB", "1TB", "₹224300");
mintNFT("Dell XPS 13", 13.4, "Green", "16GB", "512GB", "₹89900");
mintNFT("HP Spectre x360 14", 13.5, "Gold", "16GB", "1TB", "₹994900");
listNFTs();
getTotalSupply();
